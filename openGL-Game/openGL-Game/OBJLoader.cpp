...
vector<string>* OBJLoader::GetSplittedStrings(string text, char delimeter)
{
    text += delimeter;
...
float OBJLoader::GetFloatFromString(string text)
{
    float value = 0.0f;
...
float* OBJLoader::GetNormal(float* coord1, float* coord2, float* coord3)
{
